...
<JsDoc client:idle name="hpattack" h={0} />

## hpdecay

<JsDoc client:idle name="hpdecay" h={0} />

## hpsustain

<JsDoc client:idle name="hpsustain" h={0} />

## hprelease

<JsDoc client:idle name="hprelease" h={0} />

## hpenv

<JsDoc client:idle name="hpenv" h={0} />
...
<JsDoc client:idle name="bpattack" h={0} />

## bpdecay

<JsDoc client:idle name="bpdecay" h={0} />

## bpsustain

<JsDoc client:idle name="bpsustain" h={0} />

## bprelease

<JsDoc client:idle name="bprelease" h={0} />

## bpenv

<JsDoc client:idle name="bpenv" h={0} />
